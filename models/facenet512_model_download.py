"""
facenet512_model_download.py

Downloads the pretrained FaceNet-512 weights file (used by DeepFace)
and stores it inside the /Model folder of the current project.
...
FACENET512_WEIGHTS_URL = (
    "https://github.com/serengil/deepface_models/releases/"
    "download/v1.0/facenet512_weights.h5"
)

MODEL_DIR_NAME = "Model"
WEIGHTS_FILE_NAME = "facenet512_weights.h5"
...
class ModelDownloader:
    ...
    def download(self) -> None:
        ...
        print(f"[INFO] Downloading FaceNet-512 weights from:\n{self.download_url}")
...
def main() -> None:
    ...
    downloader = ModelDownloader(
        download_url=FACENET512_WEIGHTS_URL,
